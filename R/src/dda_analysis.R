...
fun_name = "dda_analysis"
figures_dir = "./figures"
dir.create(figures_dir, recursive = T)


clean_data = function() {
  files = list("./results/2017-02-15/iprophet_psm_protFDR0.01_t_1.07.csv", 
            "./results/2017-02-27/iprophet_psm_protFDR0.01_t_1.07.csv")
  data.raw <- map_df(files, read_csv) %>% bind_rows()
  ...
  write_tsv(x = data.raw, path = "./results/2017-02-27/iprophet_psm_protFDR0.01_t_1.07_tidy.csv")
  return(data.raw)  
}
